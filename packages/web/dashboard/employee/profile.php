...
try {
    ...
    // Get employee's recent tasks
    $recentTasks = $db->fetchAll("
        SELECT * FROM tts_daily_tasks 
        WHERE user_id = ? 
            ...
            <div class="col-md-4">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h5><i class="fas fa-tasks me-2"></i>Recent Tasks</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5><i class="fas fa-clock me-2"></i>This Month</h5>
                    </div>
                    <div class="card-body">
                        <?php 
                        $totalHours = array_sum(array_column($timeEntries, 'total_hours'));
                        $workingDays = count($timeEntries);
                        ?>
                        <div class="row text-center">
                            <div class="col-6">
                                <div class="border-end">
                                    <h4 class="text-primary"><?php echo number_format($totalHours, 1); ?></h4>
                                    <small class="text-muted">Total Hours</small>
                                </div>
                            </div>
                            <div class="col-6">
                                <h4 class="text-info"><?php echo $workingDays; ?></h4>
                        ...
                        <div class="mt-3">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <small><?php echo min(100, round(($totalHours / 160) * 100)); ?>%</small>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-primary" style="width: <?php echo min(100, ($totalHours / 160) * 100); ?>%"></div>
                            </div>
                            <small class="text-muted">Target: 160 hours/month</small>
                        </div>
                        
                        <div class="text-center mt-3">
                            <a href="timesheet.php" class="btn btn-primary btn-sm">
                                <i class="fas fa-clock me-1"></i>View Timesheet
                            </a>
                        </div>
                    </div>
                </div>
