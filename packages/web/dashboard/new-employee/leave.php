<?php
/**
 * TTS PMS - New Employee Leave Management
 * Leave application for new employees (limited during training)
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (isset($_POST['apply_leave'])) {
            // Apply for leave (only emergency/sick allowed during training)
            $leaveType = $_POST['leave_type'];
            
            if (!in_array($leaveType, ['sick', 'emergency'])) {
                $error = 'Only sick leave and emergency leave are allowed during training period.';
            } else {
                $leaveData = [
                ...
                $success = 'Leave application submitted successfully! HR will review your request.';
            }
...
try {
    ...
    // Training period leave balance (limited)
    $leaveBalance = [
        'sick_leave' => 5,
        'emergency_leave' => 2,
        'sick_used' => 0,
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#applyLeaveModal">
                <i class="fas fa-plus me-2"></i>Apply for Leave
            </button>
        </div>

        <!-- Training Period Notice -->
        <div class="alert alert-warning mb-4">
            <i class="fas fa-info-circle me-2"></i>
            <strong>Training Period Policy:</strong> During your training period, only sick leave and emergency leave are available. Annual and casual leave will be accessible after successful completion of onboarding.
        </div>
                ...
                <div class="card leave-balance-card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">
                            <i class="fas fa-calendar-check me-2"></i>Training Period Leave Balance
                        </h5>
                        <div class="row text-center">
                            ...
                            <div class="col-md-6">
                                <div class="leave-type-card bg-white bg-opacity-10 p-3 rounded">
                                    <h3><?php echo $leaveBalance['emergency_leave'] - $leaveBalance['emergency_used']; ?></h3>
                                    <p class="mb-1">Emergency Leave</p>
                                    <small class="opacity-75">Used: <?php echo $leaveBalance['emergency_used']; ?> / <?php echo $leaveBalance['emergency_leave']; ?></small>
                                </div>
                            </div>
                        </div>
                        <div class="text-center mt-3">
                            <small class="opacity-75">
                                <i class="fas fa-lock me-1"></i>Annual and Casual leave will be available after training completion
                            </small>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <span class="badge bg-<?php echo $request['leave_type'] === 'sick' ? 'danger' : 'warning'; ?>">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-calendar-plus me-2"></i>Apply for Leave (Training Period)
                    </h5>
                ...
                <form method="POST">
                    <div class="modal-body">
                        ...
                        <div class="alert alert-warning">
                            <i class="fas fa-info-circle me-2"></i>
                            <strong>Training Period Restriction:</strong> Only sick leave and emergency leave are available during your training period.
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Annual and casual leave will be available after training completion.</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle me-2"></i>
                            <strong>Note:</strong> All leave requests require HR approval during training period. You will be notified via email once your request is processed.
                        </div>
                    </div>
