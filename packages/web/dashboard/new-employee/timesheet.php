<?php
/**
 * TTS PMS - New Employee Timesheet
 * Time tracking and timesheet management for new employees
 */
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="alert alert-warning mb-4">
            ...
            <strong>New Employee Notice:</strong> Time tracking helps us monitor your onboarding progress and training hours.
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            <div class="col-4">
                                <div class="border-end">
                                    <h4 class="text-warning"><?php echo $todayEntry ? number_format($todayEntry['total_hours'], 1) : '0.0'; ?></h4>
                        ...
                        <div class="mt-3">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <small><?php echo min(100, round(($monthTotal / 80) * 100)); ?>%</small>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-warning" style="width: <?php echo min(100, ($monthTotal / 80) * 100); ?>%"></div>
                            </div>
                            <small class="text-muted">Target: 80 hours/month (training period)</small>
                        </div>
                    </div>
                </div>
            </div>
